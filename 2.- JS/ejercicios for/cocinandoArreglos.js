...
ingredientes.push([
  3,
  "Chiles guajillo sin semilla y remojados en agua caliente",
]); //0
...
ingredientes.push([
  5,
  "Ramitas de Cilantro fresco desinfectadas y picadas finamente",
]); //9
...
while (index < ingredientes.length) {
  ...
  pasosHTML += `<li>${ingredientes[index][0]} ${ingredientes[index][1]}</li>
        <span>oink!</span>
    `;
  index++;
}
